...
2. `Cbc.encrypt(byte[] data, int length)` (Cbc.java, line 161)
    ...
    - Unit tests generated
        ...
        | ---                       | ---           | ---             | ---         |
        | ({}, 0) | `data`: 1; `length`: 1 | {} | Test passed |
        | ({0x01, 0x01, 0x01, 0x01}, 4) | `data`: 2,3; `length`: 2,3; `i`: 1,4,5,6,7,8,9; `BLOCK_SIZE`: 2; `this._overflowUsed`: 1,4 | {} | Test passed |
        | ({0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01}, 17) | `data`: 2,3; `length`: 2,3; `i`: 1,4,5,6,7,8,9; `BLOCK_SIZE`: 2; `this._overflow`: 3; `this._overflowUsed`: 1,4,7; `this._outBuffer`: 5 | {0x7b, 0xc3, 0x02, 0x6c, 0xd7, 0x37, 0x10, 0x3e, 0x62, 0x90, 0x2b, 0xcd, 0x18, 0xfb, 0x01, 0x63} | Test passed |
        | ({0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01}, 15) + ({0x01}, 1) | `data`: 2,3; `length`: 2,3; `i`: 1,4,5,6,7,8,9; `BLOCK_SIZE`: 1,2; `this._overflow`: 3; `this._overflowUsed`: 1,4; `this._output`: 1; `this._outBuffer`: 5 | {0x7b, 0xc3, 0x02, 0x6c, 0xd7, 0x37, 0x10, 0x3e, 0x62, 0x90, 0x2b, 0xcd, 0x18, 0xfb, 0x01, 0x63} | Test passed |
